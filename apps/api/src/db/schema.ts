...
import { bigserial, boolean, index, pgTable, primaryKey, text, timestamp, varchar } from 'drizzle-orm/pg-core'
...
export const schema = { user, session, account, verification, artist, scrape, scrapeArtist }
