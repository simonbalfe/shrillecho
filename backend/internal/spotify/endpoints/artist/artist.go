...
import (
	"encoding/json"
	"fmt"
	models "github.com/smwbalfe/shrillecho-playlist-archive/backend/internal/spotify/endpoints/artist/models"
	"github.com/smwbalfe/shrillecho-playlist-archive/backend/internal/spotify/interface"
	"net/url"
	"strings"
)
